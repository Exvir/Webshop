...
class Product(models.Model):
	...
	first_additional_image = models.ImageField(upload_to=image_folder, null=True)
	second_additional_image = models.ImageField(upload_to=image_folder, null=True)
	third_additional_image = models.ImageField(upload_to=image_folder, null=True)
