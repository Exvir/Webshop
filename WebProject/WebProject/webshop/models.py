...
class Product(models.Model):
	...
	first_additional_image = models.ImageField(upload_to=image_folder, blank=True, null=True)
	second_additional_image = models.ImageField(upload_to=image_folder, blank=True, null=True)
	third_additional_image = models.ImageField(upload_to=image_folder, blank=True, null=True)
